...
import scape.editor.fs.graphics.RSTexture;

public class RSRasterizer extends RSRaster {
    ...
    public static RSTexture[] textures = new RSTexture[50];
    ...
    static int[] textureColourAverages = new int[50];
    ...
    public static int averageTextureColour(int texture) {
        if (textureColourAverages[texture] != 0) {
            return textureColourAverages[texture];
        }
        ...
        for (int index = 0; index < count; index++) {
            r += texturePalettes[texture][index] >> 16 & 0xff;
            g += texturePalettes[texture][index] >> 8 & 0xff;
            b += texturePalettes[texture][index] & 0xff;
        }

        int rgb = (r / count << 16) + (g / count << 8) + b / count;
        rgb = adjustBrightness(rgb, 1.4D);
        if (rgb == 0) {
            rgb = 1;
        }

        textureColourAverages[texture] = rgb;
        return rgb;
    }
    ...
    public static void loadTextures(RSArchive archive) {
        textureCount = 0;
        for (int id = 0; id < 50; id++) {
            try {
                textures[id] = RSTexture.decode(archive, String.valueOf(id), 0);

                if (lowMemory && textures[id].resizeWidth == 128) {
    ...
    public static int[] method371(int id) {
        ...
        RSTexture image = textures[id];
        int palette[] = texturePalettes[id];

        if (lowMemory) {
            aBooleanArray1475[id] = false;
            for (int i1 = 0; i1 < 4096; i1++) {
                int i2 = ai[i1] = palette[image.palettePixels[i1]] & 0xf8f8ff;
                if (i2 == 0) {
            ...
            if (image.width == 64) {
                for (int j1 = 0; j1 < 128; j1++) {
                    for (int j2 = 0; j2 < 128; j2++) {
                        ai[j2 + (j1 << 7)] = palette[image.palettePixels[(j2 >> 1) + (j1 >> 1 << 6)]];
                    }
                }
            } else {
                for (int k1 = 0; k1 < 16384; k1++) {
                    ai[k1] = palette[image.palettePixels[k1]];
                }
            }
    ...
    public static void calculatePalette(double exponent) {
        ...
        for (int k = 0; k < 512; k++) {
            ...
            for (int k1 = 0; k1 < 128; k1++) {
                ...
                colour = adjustBrightness(colour, exponent);
                if (colour == 0) {
                    colour = 1;
                }
        ...
        for (int id = 0; id < 50; id++) {
            if (textures[id] != null) {
                ...
                for (int index = 0; index < palette.length; index++) {
                    texturePalettes[id][index] = adjustBrightness(palette[index], exponent);
    ...
    public static void method374(int i, int j, int k, int l, int i1, int j1, int k1, int l1, int i2) {
        ...
        if (i <= j && i <= k) {
            if (i >= RSRaster.getClipTop()) {
                return;
            }
            if (j > RSRaster.getClipTop()) {
                j = RSRaster.getClipTop();
            }
            if (k > RSRaster.getClipTop()) {
                k = RSRaster.getClipTop();
            }
            if (j < k) {
                j1 = l <<= 16;
                i2 = k1 <<= 15;
                ...
                if (i != j && j3 < j2 || i == j && j3 > l2) {
                    k -= j;
                    j -= i;
                    for (i = scanOffsets[i]; --j >= 0; i += RSRaster.width) {
                        method375(RSRaster.raster, i, 0, 0, j1 >> 16, l >> 16, i2 >> 7, k1 >> 7);
                        j1 += j3;
                        l += j2;
                        i2 += k3;
                        k1 += k2;
                    ...
                    while (--k >= 0) {
                        method375(RSRaster.raster, i, 0, 0, j1 >> 16, i1 >> 16, i2 >> 7, l1 >> 7);
                        j1 += j3;
                        i1 += l2;
                        i2 += k3;
                        l1 += i3;
                ...
                j -= i;
                for (i = scanOffsets[i]; --j >= 0; i += RSRaster.width) {
                    method375(RSRaster.raster, i, 0, 0, l >> 16, j1 >> 16, k1 >> 7, i2 >> 7);
                    j1 += j3;
                    l += j2;
                    i2 += k3;
                    k1 += k2;
                ...
                while (--k >= 0) {
                    method375(RSRaster.raster, i, 0, 0, i1 >> 16, j1 >> 16, l1 >> 7, i2 >> 7);
                    j1 += j3;
                    i1 += l2;
                    i2 += k3;
                    l1 += i3;
            ...
            if (i != k && j3 < j2 || i == k && l2 > j2) {
                j -= k;
                k -= i;
                for (i = scanOffsets[i]; --k >= 0; i += RSRaster.width) {
                    method375(RSRaster.raster, i, 0, 0, i1 >> 16, l >> 16, l1 >> 7, k1 >> 7);
                    i1 += j3;
                    l += j2;
                    l1 += k3;
                    k1 += k2;
            ...
            k -= i;
            for (i = scanOffsets[i]; --k >= 0; i += RSRaster.width) {
                method375(RSRaster.raster, i, 0, 0, l >> 16, i1 >> 16, k1 >> 7, l1 >> 7);
                i1 += j3;
                l += j2;
                l1 += k3;
                k1 += k2;
        ...
        if (j <= k) {
            ...
            if (k < i) {
                ...
                if (j != k && j2 < l2 || j == k && j2 > j3) {
                    i -= k;
                    k -= j;
                    for (j = scanOffsets[j]; --k >= 0; j += RSRaster.width) {
                        method375(RSRaster.raster, j, 0, 0, l >> 16, i1 >> 16, k1 >> 7, l1 >> 7);
                        l += j2;
                        i1 += l2;
                        k1 += k2;
                        l1 += i3;
                    ...
                    while (--i >= 0) {
                        method375(RSRaster.raster, j, 0, 0, l >> 16, j1 >> 16, k1 >> 7, i2 >> 7);
                        l += j2;
                        j1 += j3;
                        k1 += k2;
                        i2 += k3;
                ...
                k -= j;
                for (j = scanOffsets[j]; --k >= 0; j += RSRaster.width) {
                    method375(RSRaster.raster, j, 0, 0, i1 >> 16, l >> 16, l1 >> 7, k1 >> 7);
                    l += j2;
                    i1 += l2;
                    k1 += k2;
                    l1 += i3;
                ...
                while (--i >= 0) {
                    method375(RSRaster.raster, j, 0, 0, j1 >> 16, l >> 16, i2 >> 7, k1 >> 7);
                    l += j2;
                    j1 += j3;
                    k1 += k2;
                    i2 += k3;
            ...
            if (j2 < l2) {
                k -= i;
                i -= j;
                for (j = scanOffsets[j]; --i >= 0; j += RSRaster.width) {
                    method375(RSRaster.raster, j, 0, 0, j1 >> 16, i1 >> 16, i2 >> 7, l1 >> 7);
                    j1 += j2;
                    i1 += l2;
                    i2 += k2;
                    l1 += i3;
            ...
            i -= j;
            for (j = scanOffsets[j]; --i >= 0; j += RSRaster.width) {
                method375(RSRaster.raster, j, 0, 0, i1 >> 16, j1 >> 16, l1 >> 7, i2 >> 7);
                j1 += j2;
                i1 += l2;
                i2 += k2;
                l1 += i3;
        ...
        if (i < j) {
            ...
            if (l2 < j3) {
                j -= i;
                i -= k;
                for (k = scanOffsets[k]; --i >= 0; k += RSRaster.width) {
                    method375(RSRaster.raster, k, 0, 0, i1 >> 16, j1 >> 16, l1 >> 7, i2 >> 7);
                    i1 += l2;
                    j1 += j3;
                    l1 += i3;
                    i2 += k3;
                ...
                while (--j >= 0) {
                    method375(RSRaster.raster, k, 0, 0, i1 >> 16, l >> 16, l1 >> 7, k1 >> 7);
                    i1 += l2;
                    l += j2;
                    l1 += i3;
                    k1 += k2;
            ...
            i -= k;
            for (k = scanOffsets[k]; --i >= 0; k += RSRaster.width) {
                method375(RSRaster.raster, k, 0, 0, j1 >> 16, i1 >> 16, i2 >> 7, l1 >> 7);
                i1 += l2;
                j1 += j3;
                l1 += i3;
                i2 += k3;
            ...
            while (--j >= 0) {
                method375(RSRaster.raster, k, 0, 0, l >> 16, i1 >> 16, k1 >> 7, l1 >> 7);
                i1 += l2;
                l += j2;
                l1 += i3;
                k1 += k2;
        ...
        if (l2 < j3) {
            i -= j;
            j -= k;
            for (k = scanOffsets[k]; --j >= 0; k += RSRaster.width) {
                method375(RSRaster.raster, k, 0, 0, l >> 16, j1 >> 16, k1 >> 7, i2 >> 7);
                l += l2;
                j1 += j3;
                k1 += i3;
                i2 += k3;
        ...
        j -= k;
        for (k = scanOffsets[k]; --j >= 0; k += RSRaster.width) {
            method375(RSRaster.raster, k, 0, 0, j1 >> 16, l >> 16, i2 >> 7, k1 >> 7);
            l += l2;
            j1 += j3;
            k1 += i3;
            i2 += k3;
    ...
    public static void method375(int ai[], int i, int j, int k, int l, int i1, int j1, int k1) {
        if (approximateAlphaBlending) {
            ...
            if (aBoolean1462) {
                ...
                if (i1 > RSRaster.maxRight) {
                    i1 = RSRaster.maxRight;
                }
                if (l < 0) {
                    j1 -= l * l1;
                    l = 0;
    ...
    public static void method376(int i, int j, int k, int l, int i1, int j1, int k1) {
        ...
        if (i <= j && i <= k) {
            ...
            if (j < k) {
                ...
                if (i != j && j2 < l1 || i == j && j2 > i2) {
                    ...
                    j -= i;
                    for (i = scanOffsets[i]; --j >= 0; i += RSRaster.width) {
                        method377(RSRaster.raster, i, k1, 0, j1 >> 16, l >> 16);
                        j1 += j2;
                        l += l1;
                    }

                    while (--k >= 0) {
                        method377(RSRaster.raster, i, k1, 0, j1 >> 16, i1 >> 16);
                        j1 += j2;
                        i1 += i2;
                        i += RSRaster.width;
                    }
                ...
                j -= i;
                for (i = scanOffsets[i]; --j >= 0; i += RSRaster.width) {
                    method377(RSRaster.raster, i, k1, 0, l >> 16, j1 >> 16);
                    j1 += j2;
                    l += l1;
                }

                while (--k >= 0) {
                    method377(RSRaster.raster, i, k1, 0, i1 >> 16, j1 >> 16);
                    j1 += j2;
                    i1 += i2;
                    i += RSRaster.width;
                }
            ...
            if (i != k && j2 < l1 || i == k && i2 > l1) {
                ...
                k -= i;
                for (i = scanOffsets[i]; --k >= 0; i += RSRaster.width) {
                    method377(RSRaster.raster, i, k1, 0, i1 >> 16, l >> 16);
                    i1 += j2;
                    l += l1;
                }
            ...
            k -= i;
            for (i = scanOffsets[i]; --k >= 0; i += RSRaster.width) {
                method377(RSRaster.raster, i, k1, 0, l >> 16, i1 >> 16);
                i1 += j2;
                l += l1;
            }
        ...
        if (j <= k) {
            ...
            if (k < i) {
                ...
                if (j != k && l1 < i2 || j == k && l1 > j2) {
                    ...
                    k -= j;
                    for (j = scanOffsets[j]; --k >= 0; j += RSRaster.width) {
                        method377(RSRaster.raster, j, k1, 0, l >> 16, i1 >> 16);
                        l += l1;
                        i1 += i2;
                    }

                    while (--i >= 0) {
                        method377(RSRaster.raster, j, k1, 0, l >> 16, j1 >> 16);
                        l += l1;
                        j1 += j2;
                        j += RSRaster.width;
                    }
                ...
                k -= j;
                for (j = scanOffsets[j]; --k >= 0; j += RSRaster.width) {
                    method377(RSRaster.raster, j, k1, 0, i1 >> 16, l >> 16);
                    l += l1;
                    i1 += i2;
                }

                while (--i >= 0) {
                    method377(RSRaster.raster, j, k1, 0, j1 >> 16, l >> 16);
                    l += l1;
                    j1 += j2;
                    j += RSRaster.width;
                }
            ...
            if (l1 < i2) {
                ...
                i -= j;
                for (j = scanOffsets[j]; --i >= 0; j += RSRaster.width) {
                    method377(RSRaster.raster, j, k1, 0, j1 >> 16, i1 >> 16);
                    j1 += l1;
                    i1 += i2;
                }
            ...
            i -= j;
            for (j = scanOffsets[j]; --i >= 0; j += RSRaster.width) {
                method377(RSRaster.raster, j, k1, 0, i1 >> 16, j1 >> 16);
                j1 += l1;
                i1 += i2;
            }
        ...
        if (i < j) {
            ...
            if (i2 < j2) {
                ...
                i -= k;
                for (k = scanOffsets[k]; --i >= 0; k += RSRaster.width) {
                    method377(RSRaster.raster, k, k1, 0, i1 >> 16, j1 >> 16);
                    i1 += i2;
                    j1 += j2;
                }

                while (--j >= 0) {
                    method377(RSRaster.raster, k, k1, 0, i1 >> 16, l >> 16);
                    i1 += i2;
                    l += l1;
                    k += RSRaster.width;
                }
            ...
            i -= k;
            for (k = scanOffsets[k]; --i >= 0; k += RSRaster.width) {
                method377(RSRaster.raster, k, k1, 0, j1 >> 16, i1 >> 16);
                i1 += i2;
                j1 += j2;
            }

            while (--j >= 0) {
                method377(RSRaster.raster, k, k1, 0, l >> 16, i1 >> 16);
                i1 += i2;
                l += l1;
                k += RSRaster.width;
            }
        ...
        if (i2 < j2) {
            ...
            j -= k;
            for (k = scanOffsets[k]; --j >= 0; k += RSRaster.width) {
                method377(RSRaster.raster, k, k1, 0, l >> 16, j1 >> 16);
                l += i2;
                j1 += j2;
            }
        ...
        j -= k;
        for (k = scanOffsets[k]; --j >= 0; k += RSRaster.width) {
            method377(RSRaster.raster, k, k1, 0, j1 >> 16, l >> 16);
            l += i2;
            j1 += j2;
        }
    ...
    public static void method378(int i, int j, int k, int l, int i1, int j1, int k1, int l1, int i2, int j2, int k2, int l2,
        ...
        if (i <= j && i <= k) {
            ...
            if (j < k) {
                ...
                if (i != j && i8 < i7 || i == j && i8 > k7) {
                    ...
                    i = scanOffsets[i];
                    while (--j >= 0) {
                        method379(RSRaster.raster, ai, 0, 0, i, j1 >> 16, l >> 16, i2 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
                        j1 += i8;
                        l += i7;
                        i2 += j8;
                        k1 += j7;
                    ...
                    while (--k >= 0) {
                        method379(RSRaster.raster, ai, 0, 0, i, j1 >> 16, i1 >> 16, i2 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
                        j1 += i8;
                        i1 += k7;
                        i2 += j8;
                        l1 += l7;
                ...
                i = scanOffsets[i];
                while (--j >= 0) {
                    method379(RSRaster.raster, ai, 0, 0, i, l >> 16, j1 >> 16, k1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
                    j1 += i8;
                    l += i7;
                    i2 += j8;
                    k1 += j7;
                ...
                while (--k >= 0) {
                    method379(RSRaster.raster, ai, 0, 0, i, i1 >> 16, j1 >> 16, l1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
                    j1 += i8;
                    i1 += k7;
                    i2 += j8;
                    l1 += l7;
            ...
            if (i != k && i8 < i7 || i == k && k7 > i7) {
                ...
                i = scanOffsets[i];
                while (--k >= 0) {
                    method379(RSRaster.raster, ai, 0, 0, i, i1 >> 16, l >> 16, l1 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
                    i1 += i8;
                    l += i7;
                    l1 += j8;
                    k1 += j7;
            ...
            i = scanOffsets[i];
            while (--k >= 0) {
                method379(RSRaster.raster, ai, 0, 0, i, l >> 16, i1 >> 16, k1 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
                i1 += i8;
                l += i7;
                l1 += j8;
                k1 += j7;
        ...
        if (j <= k) {
            ...
            if (k < i) {
                ...
                if (j != k && i7 < k7 || j == k && i7 > i8) {
                    ...
                    j = scanOffsets[j];
                    while (--k >= 0) {
                        method379(RSRaster.raster, ai, 0, 0, j, l >> 16, i1 >> 16, k1 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
                        l += i7;
                        i1 += k7;
                        k1 += j7;
                        l1 += l7;
                    ...
                    while (--i >= 0) {
                        method379(RSRaster.raster, ai, 0, 0, j, l >> 16, j1 >> 16, k1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
                        l += i7;
                        j1 += i8;
                        k1 += j7;
                        i2 += j8;
                ...
                j = scanOffsets[j];
                while (--k >= 0) {
                    method379(RSRaster.raster, ai, 0, 0, j, i1 >> 16, l >> 16, l1 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
                    l += i7;
                    i1 += k7;
                    k1 += j7;
                    l1 += l7;
                ...
                while (--i >= 0) {
                    method379(RSRaster.raster, ai, 0, 0, j, j1 >> 16, l >> 16, i2 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
                    l += i7;
                    j1 += i8;
                    k1 += j7;
                    i2 += j8;
            ...
            if (i7 < k7) {
                ...
                j = scanOffsets[j];
                while (--i >= 0) {
                    method379(RSRaster.raster, ai, 0, 0, j, j1 >> 16, i1 >> 16, i2 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
                    j1 += i7;
                    i1 += k7;
                    i2 += j7;
                    l1 += l7;
            ...
            j = scanOffsets[j];
            while (--i >= 0) {
                method379(RSRaster.raster, ai, 0, 0, j, i1 >> 16, j1 >> 16, l1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
                j1 += i7;
                i1 += k7;
                i2 += j7;
                l1 += l7;
        ...
        if (i < j) {
            ...
            if (k7 < i8) {
                ...
                k = scanOffsets[k];
                while (--i >= 0) {
                    method379(RSRaster.raster, ai, 0, 0, k, i1 >> 16, j1 >> 16, l1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
                    i1 += k7;
                    j1 += i8;
                    l1 += l7;
                    i2 += j8;
                ...
                while (--j >= 0) {
                    method379(RSRaster.raster, ai, 0, 0, k, i1 >> 16, l >> 16, l1 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
                    i1 += k7;
                    l += i7;
                    l1 += l7;
                    k1 += j7;
            ...
            k = scanOffsets[k];
            while (--i >= 0) {
                method379(RSRaster.raster, ai, 0, 0, k, j1 >> 16, i1 >> 16, i2 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
                i1 += k7;
                j1 += i8;
                l1 += l7;
                i2 += j8;
            ...
            while (--j >= 0) {
                method379(RSRaster.raster, ai, 0, 0, k, l >> 16, i1 >> 16, k1 >> 8, l1 >> 8, l4, k5, j6, i5, l5, k6);
                i1 += k7;
                l += i7;
                l1 += l7;
                k1 += j7;
        ...
        if (k7 < i8) {
            ...
            k = scanOffsets[k];
            while (--j >= 0) {
                method379(RSRaster.raster, ai, 0, 0, k, l >> 16, j1 >> 16, k1 >> 8, i2 >> 8, l4, k5, j6, i5, l5, k6);
                l += k7;
                j1 += i8;
                k1 += l7;
                i2 += j8;
        ...
        k = scanOffsets[k];
        while (--j >= 0) {
            method379(RSRaster.raster, ai, 0, 0, k, j1 >> 16, l >> 16, i2 >> 8, k1 >> 8, l4, k5, j6, i5, l5, k6);
            l += k7;
            j1 += i8;
            k1 += l7;
            i2 += j8;
    ...
    public static void useViewport() {
        scanOffsets = new int[RSRaster.height];
        for (int j = 0; j < RSRaster.height; j++) {
            scanOffsets[j] = RSRaster.width * j;
        }

        originViewX = RSRaster.width / 2;
        originViewY = RSRaster.height / 2;
    }
